...
pub fn get_model_config(model_id: &str) -> Option<ModelConfig> {
    match model_id {
        ...
        "granite-speech-1b" => Some(ModelConfig {
            ...
            files: vec![
                ModelFile {
                    filename: "audio_encoder_fp16.onnx",
                    remote_path: "onnx/audio_encoder_fp16.onnx",
                    sha1: "",
                },
                ModelFile {
                    filename: "audio_encoder_fp16.onnx_data",
                    remote_path: "onnx/audio_encoder_fp16.onnx_data",
                    sha1: "",
                },
                ModelFile {
                    filename: "embed_tokens_fp16.onnx",
                    remote_path: "onnx/embed_tokens_fp16.onnx",
                    sha1: "",
                },
                ModelFile {
                    filename: "embed_tokens_fp16.onnx_data",
                    remote_path: "onnx/embed_tokens_fp16.onnx_data",
                    sha1: "",
                },
                ModelFile {
                ...
                ModelFile {
                    filename: "decoder_model_merged_fp16.onnx_data_1",
                    remote_path: "onnx/decoder_model_merged_fp16.onnx_data_1",
                    sha1: "",
                },
                ModelFile {
